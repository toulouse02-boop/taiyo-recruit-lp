...
export default function TaiyoNoHanaRecruitLP() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 lg:py-20 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <button className="bg-orange-500 hover:bg-orange-600 transition text-white px-8 py-4 rounded-2xl text-lg font-bold shadow-lg">
                見学・応募はこちら
              </button>
              <button className="border-2 border-orange-400 text-orange-500 px-8 py-4 rounded-2xl text-lg font-bold hover:bg-orange-50 transition">
                LINEで相談する
              </button>
            </div>
        ...
        <div className="max-w-5xl mx-auto bg-orange-500 rounded-[40px] p-10 lg:p-16 text-white shadow-2xl">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="bg-white rounded-3xl p-8 text-gray-700">
              ...
              <button className="w-full mt-8 bg-orange-500 hover:bg-orange-600 transition text-white py-4 rounded-2xl text-lg font-bold shadow-lg">
                応募・見学予約をする
              </button>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-10 px-6">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-4">
            ...
            <button className="border border-gray-600 hover:bg-gray-800 transition px-6 py-3 rounded-xl font-bold">
              LINE相談
            </button>
          </div>
        </div>
